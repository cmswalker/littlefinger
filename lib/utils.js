...
const errorMessages = {
  ...
  noOutput: 'Must provide output path for composed package.json',
  noDependencyTypes: `Must at least one of package.json dependency types ${Array.from(DEPENDENCY_TYPES)}`,
};
